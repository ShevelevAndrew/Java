 ...
 *
 * Реализован функционал шифрования пароля MD5 через класс MD5Util, передается пароль в шифрованом виде
 *
 * @author Sergey Iryupin (modifid Andrew Shevelev)
 * @version dated Jun 27, 2018
 */
...
class SimpleClient implements IConstants {
    ...
    private String getLoginAndPassword(Scanner scanner) {
        ...
        return AUTH_SIGN + " " + login + " " + MD5Util.md5Custom(scanner.nextLine().trim());
    }
